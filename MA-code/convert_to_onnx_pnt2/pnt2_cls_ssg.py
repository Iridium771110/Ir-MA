# This file defines the model for SSG
# The model structure is the same as the original project but is modified for the convenience of converting
...
class pnt2_cls_ssg(nn.Module):
    ...
    def _break_up_pc(self, pc):
        # This function is modified for converting, the if branch causes trouble in converting
    ...
    def forward(self, pointcloud):
        # This function is modified for converting
        # In converting data type should be fixed. It is not flexible as python
        # The last SA_module returns different from the others. Write the forward step by step 
