...
template void SamplingKernel<float>::Compute(OrtKernelContext *context);

// void SamplingKernel<float>::Compute(OrtKernelContext *context){

//     const OrtValue* input_data=ort_.KernelContext_GetInput(context,0);
//     const float* original=reinterpret_cast<const float*>(ort_.GetTensorData<float>(input_data));
//     OrtTensorDimensions dims_i(ort_,input_data);
//     const int64_t b_size=dims_i[0];
//     const int64_t o_p_num=dims_i[1];
