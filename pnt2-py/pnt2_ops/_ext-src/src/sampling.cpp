...
void gather_points_grad_kernel_wrapper(int b, int c, int n, int npoints,
                                       ...
                                       float *grad_points); //反向传播部分，硬件部署用不上，仅作训练用
...
// static auto registry=torch::RegisterOperators("pnt2_ops::sampling",&furthest_point_sampling);
// static auto registry_1=torch::RegisterOperators("pnt2_ops::gather_points",&gather_points);
